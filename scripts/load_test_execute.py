...
Usage:
    python scripts/load_test_execute.py <case_id> [num_requests] [concurrency]
"""
...
def main():
    ...
    print(f"Load test on /admin/execute-retry for {case_id}: {n} req, concurrency {concurrency}")
